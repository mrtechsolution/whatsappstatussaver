...
import com.mrtech.whatsappstatussaver.recycler.ImageViewHolder
...
class WAImageAdapter(
    ...
    override fun onBindViewHolder(
        ...
        if (selectedIds[position]) holder.imageViewCheck.visibility =
            View.VISIBLE else holder.imageViewCheck.visibility = View.GONE
    }
    ...
    override fun onCreateViewHolder(
        ...
        return ImageViewHolder(mainGroup)
    }
