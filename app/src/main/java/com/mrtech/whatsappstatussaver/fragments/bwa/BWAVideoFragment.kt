...
//            }
    ...
    private fun populateRecyclerView() {
        ...
        status
        waVideoAdapter = WAVideoAdapter(requireActivity(), arrayList)
        ...
        if (hasCheckedItems && mActionMode == null) {
            ...
            mActionMode = (getActivity() as AppCompatActivity?)!!.startSupportActionMode(
                (ToolbarActionModeCallback(
                    requireActivity(), GenericAdapter(waVideoAdapter), arrayList, InstanceHandler(
                        mInstance
                    )
                        ...
                        while (i < listFiles.size) {
                            try {
                                ...
                                if (str.endsWith(".mp4") || str.endsWith(".avi") || str.endsWith(".mkv") || str.endsWith(
                                    ...
                                    val helperMethods = HelperMethods(requireActivity().applicationContext)
...
//    }
    ...
    companion object {
        private var mInstance: BWAVideoFragment? = null
